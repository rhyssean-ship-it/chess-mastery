...
function PlanIndex() {
  ...
  return (
    <div className="page-enter max-w-6xl mx-auto px-6 py-10">
      ...
      <p className="text-text-dim text-sm mb-8">Learn the right plans for every pawn structure.</p>
...
function PlanDetail() {
  ...
  return (
    <div className="page-enter max-w-3xl mx-auto px-6 py-10">
      ...
      <p className="text-text-dim text-sm mb-8">{plan.structure} &middot; {plan.difficulty}</p>
