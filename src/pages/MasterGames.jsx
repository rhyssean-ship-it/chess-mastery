...
function GamesIndex() {
  return (
    <div className="page-enter max-w-6xl mx-auto px-6 py-10">
      ...
      <p className="text-text-dim text-sm mb-8">Study how the greatest players navigated complex positions.</p>
...
function GameViewer() {
  ...
  return (
    <div className="page-enter max-w-6xl mx-auto px-6 py-10">
      ...
      <p className="text-text-dim text-sm mb-1">{game.event} &middot; Result: {game.result}</p>
      <p className="text-text-dim text-xs mb-8">{game.description}</p>
        ...
        <div className="space-y-4">
          ...
          {currentAnnotation ? (
            <div className="card-base p-5 border-gold/20">
              ...
              <p className="text-sm text-text-dim leading-relaxed">{currentAnnotation}</p>
            </div>
          ) : (
            <div className="card-base p-5 opacity-50">
              <p className="text-sm text-text-dim italic">No annotation for this move.</p>
            </div>
          )}
        </div>
      </div>
