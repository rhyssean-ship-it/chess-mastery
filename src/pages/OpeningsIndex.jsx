...
export default function OpeningsIndex() {
  ...
  return (
    <div className="page-enter max-w-6xl mx-auto px-4 py-10">
      <h1 className="text-3xl font-display text-gold mb-2">Openings Library</h1>
      <p className="text-text-dim mb-8">Master the most important chess openings with interactive trainers.</p>
